...
public class SellerFormController implements Initializable {
	...
	private void setErrorMessage(Map<String, String> error) {
		...
		labelErrorName.setText((field.contains("name") ? error.get("name") : ""));
		labelErrorEmail.setText((field.contains("email") ? error.get("email") : ""));
		labelErrorDate.setText((field.contains("birthDate") ? error.get("birthDate") : ""));
		labelErrorBaseSalary.setText((field.contains("baseSalary") ? error.get("baseSalary") : ""));
